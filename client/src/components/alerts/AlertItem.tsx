...
const AlertItem: React.FC<AlertItemProps> = ({ alert }) => {
  ...
  // Set avatar image based on alert type
  let avatarImage = "";
  if (alert.type.includes("friend")) {
    avatarImage = "https://images.unsplash.com/photo-1580894732444-8ecded7900cd?auto=format&fit=crop&w=100&h=100";
  } else if (alert.type.includes("game")) {
    avatarImage = "https://images.unsplash.com/photo-1573497620053-ea5300f94f21?auto=format&fit=crop&w=100&h=100";
  } else if (alert.type.includes("scripture")) {
    avatarImage = "https://images.unsplash.com/photo-1529070538774-1843cb3265df?auto=format&fit=crop&w=100&h=100";
  } else {
    avatarImage = "https://images.unsplash.com/photo-1516627145497-ae6968895b40?auto=format&fit=crop&w=100&h=100";
  }
  
  const firstInitial = alert.type.charAt(0).toUpperCase();
  const timeAgo = alert.createdAt ? formatDistanceToNow(new Date(alert.createdAt), { addSuffix: true }) : 'recently';
